...
python bazi.py   1995   06 10   14 -g -n 
...
优化print输出内容，让客户更加容易理解，并且保持逻辑不变。若存在基础和母法总则等页数相关内容可以删除，并且修改。


1.首先，我需要在小红薯上去寻找我的目标客户，比如在八字话题下评论客户自己八字截图的人。 2.我需要针对这个八字进行分析，并发送有吸引力的报告，最后通过报告引流至私域。3.通过话术以及价格表提供服务内容。 4.完成客户数据录入，以及后端分析成交率，转化率。


参考以上代码，将print内容注释，并且将其中的内容append到对应容器中。