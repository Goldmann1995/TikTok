...
health_impact_of_five_elements = {
    "五行": {
        "水": {
            "强": {
                "健康影响": "水旺之人通常肾脏功能较强，精力充沛，但也可能导致体内湿气过重，影响脾胃功能，出现水肿、体重增加等问题。",
                "注意事项": [
                    "保持适度运动，促进新陈代谢，减少湿气积聚。",
                    "避免过多摄入冷饮和寒性食物，如西瓜、苦瓜等。",
                    "保持室内通风，避免长时间处于潮湿环境中。"
                ]
            },
            "弱": {
                "健康影响": "水弱之人可能肾脏功能较弱，容易感到疲劳、腰膝酸软，皮肤干燥、口渴等症状，且免疫力可能下降。",
                "注意事项": [
                    "适量增加水的摄入量，保持体内水分平衡。",
                    "多食用黑色食物，如黑豆、黑木耳等，以补肾气。",
                    "避免过度劳累，保持良好的作息习惯，保证充足的睡眠。"
                ]
            }
        },
        "木": {
            "强": {
                "健康影响": "木旺之人肝胆功能较强，但可能易怒、头痛、眼睛疲劳。",
                "注意事项": [
                    "保持情绪稳定，避免过度紧张和压力。",
                    "注意保护眼睛，避免长时间用眼。",
                    "适当食用酸性食物，如柠檬、山楂等。"
            ...
            "弱": {
                "健康影响": "木弱之人可能肝胆功能较弱，容易疲劳、抑郁、肌肉无力。",
                "注意事项": [
                    "增加绿色蔬菜的摄入，如菠菜、青椒等。",
                    "适当进行舒展运动，如瑜伽、太极等。",
                    "保持乐观积极的心态，多与人交流。"
        ...
        "火": {
            ...
            "弱": {
                "健康影响": "火弱之人可能心脏功能较弱，容易心悸、手脚冰凉、精神不振。",
                "注意事项": [
                    "适当增加温热性食物，如红枣、桂圆等。",
                    "保持适度运动，增强心肺功能。",
                    "注意保暖，特别是在寒冷季节。"
        ...
        "土": {
            ...
            "弱": {
                "健康影响": "土弱之人可能脾胃功能较弱，容易消化不良、食欲不振、四肢乏力。",
                "注意事项": [
                    "注意饮食清淡易消化，少食多餐。",
                    "适当食用健脾益胃的食物，如山药、红薯等。",
                    "保持良好的饮食习惯，避免生冷食物。"
        ...
        "金": {
            ...
            "弱": {
                "健康影响": "金弱之人可能肺部功能较弱，容易感冒、气短、免疫力低下。",
                "注意事项": [
                    "增强体质，适当进行有氧运动。",
                    "注意保暖，避免受凉。",
                    "适当食用补肺益气的食物，如白萝卜、蜂蜜等。"
                ]
            }
        }
    }
